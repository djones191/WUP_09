...
We are using numerical~numerical because all of the explanatory variables are numerical.
...
pairs(FishiesB)
```
I would estimate from the graph above that Length2 and Length 3 may be the best variables to try and estimate weight in a linear model for bream fish.
...
Length 1 and Width are the best variables for Perch.   
Length 1 and Length 2 are the best variables for Smelt.  
Length 2 and Length 3 are the best variables for Bream.    
